...
# 2  7 [0, 1, 1, 2, 2, 3, 3, 1, 2, 2, 3, 3, 4, 4, 2, 3]
# 3  8 [0, 1, 1, 2, 2, 3, 3, 1, 1, 2, 2, 3, 3, 4, 2, 2]
# 4 12 [0, 1, 1, 2, 2, 3, 3, 1, 1, 2, 2, 3, 1, 2, 2, 2]
# 5 50 [0, 1, 1, 2, 2, 3, 3, 1, 1, 2, 2, 3, 1, 2, 2, {2}]
# 
# ※ 例えば、c[1]=2のときは、
# t[2] (j=2)から更新を開始する。(更新する前の値はt[2]=2)
# 2 (t[j])と 0 (=t[0] =t[2-2] =t[t[2]-c[1]])に1を足したものを比較し、小さい方の1をt[2]へ変更。
